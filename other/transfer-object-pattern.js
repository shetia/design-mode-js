...
class StudentBO {
  ...
  updateStudent(student){
    ...
    console.log(`Student: Roll No ${student.getRollNo()}, updated inthis database`)
  }
}
...
Student: Roll No 0, updated inthis database
Student: [RollNo: 0, Name: Michael]
*/

/*
优势
代码看起来和数据访问对象模式很像， 但是表达的意思是完全不一样的
传输对象模式表达的是一种创世模型， 数据访问对象模式表达的是模型层和操作层的分离
*/